    ...
    const handleConnect = useCallback(async () => {
        ...
        try {
            ...
            if (authConfig?.type === 'oauth2') {
                ...
                let windowUrl = `${baseUrl}/connect/oauth2/${selectedIntegration.provider}?redirect_uri=${callbackEmbeddedAccountsUrl}&token=${token}&provider_version=${selectedIntegration.version}`; //Adding a comment here
